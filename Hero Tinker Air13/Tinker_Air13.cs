       ...
       public static Vector3 FindVector(Vector3 first, double ret, float distance)
        ...
        static void Information(EventArgs args)
        {
			...
			if (Menu.Item("dmgcalc").GetValue<bool>())
				  {
            text.DrawText("x", new Vector2(HUDInfo.ScreenSizeX() / 2 + 2 -240 + coordX, HUDInfo.ScreenSizeY() / 2 + 260 + 2), new Vector2(30, 200), Color.Black, FontFlags.AntiAlias);
            text.DrawText("x", new Vector2(HUDInfo.ScreenSizeX() / 2-240 + coordX, HUDInfo.ScreenSizeY() / 2 + 260), new Vector2(30, 200), Color.White, FontFlags.AntiAlias);			
